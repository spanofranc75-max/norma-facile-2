...
function RilieviSVG() {
    return (
        <svg viewBox="0 0 200 160" fill="none" className="w-full h-full">
            ...
            <line x1="115" y1="32" x2="115" y2="27" stroke="white" strokeWidth="1" />
            <line x1="124" y1="32" x2="124" y2="29" stroke="white" strokeWidth="1" />
            <line x1="133" y1="32" x2="133" y2="27" stroke="white" strokeWidth="1" />
            <line x1="142" y1="32" x2="142" y2="29" stroke="white" strokeWidth="1" />
            <line x1="151" y1="32" x2="151" y2="27" stroke="white" strokeWidth="1" />
            <line x1="160" y1="32" x2="160" y2="29" stroke="white" strokeWidth="1" />
            <line x1="169" y1="32" x2="169" y2="27" stroke="white" strokeWidth="1" />
...
const SVG_MAP = {
    ...
    rilievi: RilieviSVG,
    distinte: DistinteSVG,
    preventivi: PreventiviSVG,
    fascicolo: FascicoloSVG,
};

export default function EmptyState({ type = 'clients', title, description, actionLabel, onAction }) {
    const SvgComponent = SVG_MAP[type] || SVG_MAP.clients;
