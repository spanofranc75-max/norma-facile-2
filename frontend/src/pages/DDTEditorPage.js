            ...
            <div className="space-y-4" data-testid="ddt-editor">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        {!isNew && <Button variant="outline" onClick={() => { const w = window.open(`${process.env.REACT_APP_BACKEND_URL}/api/ddt/${ddtId}/pdf?token=${localStorage.getItem('session_token')}`, '_blank'); if(w) setTimeout(()=>w.print(),1500); }} className="border-purple-500 text-purple-600 hover:bg-purple-50 h-9 text-xs"><Printer className="h-3.5 w-3.5 mr-1.5" /> Stampa</Button>}
                        {!isNew && (
                            <Button
                                type="button"
                                variant="outline"
