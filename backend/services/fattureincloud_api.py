...
def map_fattura_to_fic(invoice: dict, client: dict) -> Dict[str, Any]:
    ...
    payload = {
        ...
        "entity": {
            "name": client.get("business_name") or "",
            "vat_number": client.get("partita_iva") or "",
            "tax_code": client.get("codice_fiscale") or "",
            "address_street": client.get("address") or "",
            "address_postal_code": client.get("cap") or "",
            "address_city": client.get("city") or "",
            "address_province": client.get("province") or "",
            "country": "Italia",
            "country_iso": client.get("country") or "IT",
            "ei_code": client.get("codice_sdi") or "0000000",
            "certified_email": client.get("pec") or "",
        },
